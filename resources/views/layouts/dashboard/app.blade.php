        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <?php      $profileImage = Auth::user()->image; ?>
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('uploads/user_images/'.$profileImage)}}" class="user-image" alt="User Image">

                        </a>
                        <ul class="dropdown-menu">
                            {{--<!-- User image -->--}}
                            <li class="user-header">
                                <img src="{{asset('uploads/user_images/'.$profileImage)}}" class="img-circle" alt="User Image">
                                <p>
...
<script>
    ...
    var pusher = new Pusher('16710043ce2638e8b7ba', {
        cluster: 'eu'
    });
</script>
